-- Minimal stand-in for the parts of a Supabase database that Roost's migrations and seed use.
-- For validating SQL against plain Postgres when Docker (and `supabase start`) is unavailable.
